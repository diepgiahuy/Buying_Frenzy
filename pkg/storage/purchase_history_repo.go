...
func (r *HistoryStore) Add(ctx context.Context, history model.PurchaseHistory) (*model.PurchaseHistory, error) {
...
func (r *HistoryStore) DeleteByID(ctx context.Context, historyId int64) error {
